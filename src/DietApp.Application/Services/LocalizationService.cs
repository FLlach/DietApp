...
public class LocalizationService : ILocalizationService
{
    ...
    private static readonly Dictionary<string, string> SpanishStrings = new(StringComparer.OrdinalIgnoreCase)
    {
        ...
        ["Nutrient_Protein"] = "Proteina (g)",

        // Pantalla Agregar Alimento
        ["AddFood_Title"] = "Agregar Nuevo Alimento",
        ["AddFood_Header"] = "Nuevo Alimento con Perfil Nutricional",
        ["AddFood_Subtitle"] = "Ingresa los datos del alimento y la cantidad de proteinas y minerales presentes por porcion de referencia (por ejemplo 100g):",
        ...
        ["AddFood_Calories"] = "Calorias (kcal por porcion)",
        ["AddFood_Protein"] = "Proteina (g por porcion)",
        ["AddFood_SaveButton"] = "Guardar Alimento en Catalogo",
        ["DailyTracking_ProteinTotal"] = "Proteina total del dia:",
        ["FoodCatalog_NutrientOrMineral"] = "Nutriente o Mineral:",
        ["FoodCatalog_SortByProteinDesc"] = "Proteina (Mayor a menor)",
        ["FoodCatalog_SortByProteinAsc"] = "Proteina (Menor a mayor)",
        ["Sort_Protein"] = "Proteina (g)",
        ["Sort_ProteinDesc"] = "Proteina (Mayor a menor)",
        ["Sort_ProteinAsc"] = "Proteina (Menor a mayor)",
        ["Sort_NameAsc"] = "Nombre (A-Z)",
        ...
        ["FoodCatalog_FilterTitle"] = "Filtros por Nutrientes y Minerales",
        ["FoodCatalog_SearchName"] = "Buscar por nombre...",
        ["FoodCatalog_Mineral"] = "Nutriente / Mineral",
        ["FoodCatalog_MinMg"] = "Minimo",
        ["FoodCatalog_MaxMg"] = "Maximo",
        ["FoodCatalog_NewFood"] = "+ Nuevo Alimento",
        ["FoodCatalog_SortTitle"] = "Ordenar por",
    ...
    private static readonly Dictionary<string, string> EnglishStrings = new(StringComparer.OrdinalIgnoreCase)
    {
        ...
        ["AddFood_Header"] = "New Food with Nutritional Profile",
        ["AddFood_Subtitle"] = "Enter food details and quantities of protein and minerals present in the reference portion (e.g. 100g):",
        ...
        ["AddFood_Calories"] = "Calories (kcal per portion)",
        ["AddFood_Protein"] = "Protein (g per portion)",
        ["AddFood_SaveButton"] = "Save Food to Catalog",
        ["DailyTracking_ProteinTotal"] = "Daily total protein:",
        ["FoodCatalog_NutrientOrMineral"] = "Nutrient or Mineral:",
        ["FoodCatalog_SortByProteinDesc"] = "Protein (Highest to lowest)",
        ["FoodCatalog_SortByProteinAsc"] = "Protein (Lowest to highest)",
        ["Sort_Protein"] = "Protein (g)",
        ["Sort_ProteinDesc"] = "Protein (Highest to lowest)",
        ["Sort_ProteinAsc"] = "Protein (Lowest to highest)",
        ...
        ["FoodCatalog_FilterTitle"] = "Nutrient & Mineral Filters",
        ["FoodCatalog_SearchName"] = "Search by name...",
        ["FoodCatalog_Mineral"] = "Nutrient / Mineral",
        ["FoodCatalog_MinMg"] = "Minimum",
        ["FoodCatalog_MaxMg"] = "Maximum",
        ["FoodCatalog_NewFood"] = "+ New Food",
        ["FoodCatalog_SortTitle"] = "Sort by",
